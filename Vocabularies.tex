...
term property dictionary as described below.
The keys in the \textit{terms} dictionary are the strings used in
machine-readable data.
\end{description}

The dictionaries present as values in the terms dictionary can have the
following keys:
...
\item[wider] A list of ``wider'' terms.  Most IVOA vocabularies are
...
\item[narrower] A list of ``narrower'' terms.  In SKOS-flavoured
...
\item Desise now contains an inversiono of wider, narrower, with meanings
...
managing vocabulary metadata. Also stating there\todo{Should there be anything normative to this effect?} that IVOA-managed
