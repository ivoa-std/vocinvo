...
\item[UCDs \citep{2007ivoa.spec.0402P}] UCDs are related to vocabularies in
...
As long as a vocabulary has not been approved, their develoment can
...
Changes to approved vocabularies are only performed by the chair of the
Semantics WG based on VEPs.  Therefore, third-party pull requests against
